...
public abstract class PersistencePolicy {
     ...
     *
     * @param c the {@code Class} to retrieve the primary key {@code Field}
     *          for
     ...
     *
     * @param f the primary key {@code Field} to check if it's set to
     *          autoincrement
     * @return {@code true} if it is set to autoincrement, {@code false} if it's
     *         not
     * @throws InfinitumRuntimeException if an explicit primary key that is set to autoincrement is
     ...
     * @param rel the {@code ModelRelationship} to retrieve the {@code Field}
     *            for
     ...
     * @throws IllegalArgumentException if the given {@code Class} is not a domain model or
     *                                  persistent
     */
     ...
     * @throws IllegalArgumentException if the containing {@link Class} of the given {@code Field} is

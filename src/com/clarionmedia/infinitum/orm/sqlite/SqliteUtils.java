...
public class SqliteUtils {
     ...
     * </p>
     *
     * @param model the model to generate the where clause for
     * @return where clause {@code String} for specified {@code Object}
     * @throws InfinitumRuntimeException if there is an error generating the SQL
     */
     ...
     * </p>
     *
     * @param c  the {@code Class} of the model
     * @param id the primary key for the model
     * @return where clause {@code String} for specified {@code Class} and
     *         primary key
     * @throws IllegalArgumentException if there is a mismatch between the {@code Class}'s primary

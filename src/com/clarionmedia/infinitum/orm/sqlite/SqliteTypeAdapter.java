...
public abstract class SqliteTypeAdapter<T> implements TypeAdapter<T> {
     ...
     * {@link SqliteDataType}.
     *
     * @param dataType the {@code SqliteDataType} of the column this type maps to
     */
     ...
     * @param column the column being mapped to
     * @param values the {@link ContentValues} containing the data mappings for the
     *               entire row
     */
     ...
     *
     * @param sqliteType the {@code SqliteDataType} of column
     */

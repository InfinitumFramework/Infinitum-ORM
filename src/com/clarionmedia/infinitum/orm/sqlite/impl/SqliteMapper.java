...
public class SqliteMapper extends ObjectMapper {
     ...
     *
     * @param type the {@code Class} to retrieve a {@code SqliteTypeResolver} for
     * @return {@code SqliteTypeResolver} for the given type
     * @throws InvalidMappingException if no {@code SqliteTypeResolver} exists for the given
     *                                 {@code Class}
     */
     ...
     *
     * @param field the{@code Field} to retrieve the SQLite data type for
     ...
     *
     * @param object the {@code Object} to retrieve the SQLite data type for

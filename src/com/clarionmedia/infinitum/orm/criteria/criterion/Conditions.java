...
public class Conditions {
     ...
     * </p>
     *
     * @param fieldName the name of the {@code Field} to place the restriction on
     ...
     *
     * @param lhs the left-hand side of the {@link LogicalExpression}
     * @param rhs the right-hand side of the {@code LogicalExpression}

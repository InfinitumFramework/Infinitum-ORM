...
public interface SqlBuilder {
     ...
     * created.
     *
     * @param dbHelper the {@code SqliteDbHelper} encapsulating the
     *                 {@code InfinitumContext} for this application
     * @return number of tables created
     * @throws ModelConfigurationException if table(s) cannot be created due to a misconfigured model.
     ...
     *
     * @param criteria the {@code Criteria} to build the SQL query from
     * @return SQL query
     */
     ...
     * </p>
     *
     * @param rel       the {@link ManyToManyRelationship} containing the association
     *                  being queried
     * @param id        the ID in which the associated records are linked with
     * @param direction the direction the relationship is being queried in, returning
     *                  records of this {@link Class}
     * @return SQL query
     * @throws InfinitumRuntimeException if the direction {@code Class} is not a part of the given
     ...
     * </p>
     *
     * @param rel         the {@link ManyToManyRelationship} for this relationship query
     * @param model       the model containing the relationship
     * @param relatedKeys the {@link List} containing the IDs of entities which are
     *                    still related
     ...
     *
     * @param rel         the {@link OneToManyRelationship} for this relationship query
     * @param model       the model containing the relationship
     * @param relatedKeys the {@link List} containing the IDs of entities which are no
     *                    longer related
     * @return {@code String} containing the SQL query
     */
     ...
     * relationship.
     *
     * @param relationship the {@link OneToOneRelationship} for this relationship query
     * @param model        the model containing the foreign key to update
     ...
     * many-to-many table.
     *
     * @param obj owner of the relationship to be deleted

...
public class OrmPreconditions {
     ...
     *
     * @param autocommit indicates if autocommit is enabled or disabled
     * @param txOpen     indicates if there is a transaction open or not
     */
     ...
     *
     * @param isOpen indicates if session is open
     */
     ...
     * deleted.
     *
     * @param model  model to check persistence for
     * @param policy {@link PersistencePolicy} to use
     */
     ...
     * loaded.
     *
     * @param c      {@code Class} to check persistence for
     * @param policy {@link PersistencePolicy} to use
     */
